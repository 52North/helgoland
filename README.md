...
Configure your client in the settings.json file in `src\apps\complete\assets\config\settings.json`. Check this `src\apps\timeseries\assets\config\settings.json` for the different configuration parameter in the settings.json. The main parameters are:
