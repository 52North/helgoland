...
- Support of different types of observation data (time series, trajectories, profiles)
- Data download (CSV)
...
The development of this client implementations was supported by several organizations and projects. Among other we would like to thank the following organizations and projects:
