...
Configure your client in the `settings.json` in the root folder (`./settings.json`). This file contains main parameters such as:

- `defaultProvider` - the default selected provider when the user starts the client
- `datasetApis` - list of all supported providers by the client
